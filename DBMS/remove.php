...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-call.m12 w3-container">
      ...
      <p class="w3-center">Remove a member from below<br/>
    <div class="w3-container w3-center">
	<a class="w3-button2" href="remsec.php" style="margin-right:10px; width:200px;">Remove a Guard</a>
	<a class="w3-button2" href="remres.php" style="width:200px;">Remove a Resident</a></br>
    </div>
 <footer id="myFooter">
